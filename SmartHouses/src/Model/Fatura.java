...
public class Fatura {
    ...
    public String toString(){
        ...
        sb.append("IdFatura: " + this.getIdFatura())
            ...
            .append("; Consumo: " + formato.format(this.getConsumo()))
            .append("; Valor: " + formato.format(this.getValor()))
            .append("; Inicio: " + this.getInicio().format(formatter))
            .append("; Fim: " + this.getFim().format(formatter) + ";");
        return sb.toString();
    }
