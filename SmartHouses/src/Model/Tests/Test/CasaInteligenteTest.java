...
public class CasaInteligenteTest 
{
    ...
    @Test
    public void testSetDeviceOn() throws SmartDeviceNotExistsException {
        SmartDevice n = new SmartCamera("cam",false,"1920x1880",1,10);
        SmartDevice n2 = new SmartCamera("cam2",true,"1920x1880",1,10);
        ...
        CasaInteligente casa = new CasaInteligente ("123","Emanuel",913913913,"Rua 25 de Abril","EDP");
        casa.setDevices(s);
        casa.setDeviceOn("cam");
        
        assertTrue(casa.getDevices().get("cam").getModo());
    }
