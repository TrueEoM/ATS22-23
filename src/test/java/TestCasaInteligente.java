...
public class TestCasaInteligente {
    ...
    private HashMap<String, List<Log>> logs = new HashMap<>();
    ...
    public void initTestCase(){
        ...
        ArrayList<Log> logL = new ArrayList<>();
        LocalDateTime dia = LocalDateTime.now();
        logL.add(new Log(dia,true));
    ...
    public void testHasLog()
    {
        ...
        assertTrue(def.hasLog("S"));
        assertFalse(def.hasLog("S3"));
    }
    ...
    public void testRemoveLog()
    {
        ...
        try {
            ...
            assertEquals("Não existem logs no device S3", e.getMessage());
        }
    }
